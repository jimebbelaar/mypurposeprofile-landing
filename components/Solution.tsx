...
const steps = [
  {
    ...
    description: 'No boring theory. Immediately applicable insights about identity, where you are now, and where you want to go.',
    duration: '30 min'
  },
  {
    number: '2',
    title: 'Talk With The AI',
    description: '15 voice prompts. The AI listens, asks questions, and sees patterns you can\'t see yourself.',
    duration: '20 min'
  },
  {
    number: '3',
    title: 'Get Your Personal Report',
    description: 'No generic advice. An action plan based on YOUR answers, YOUR situation, YOUR brain.',
    duration: 'Instant'
  }
]

const whatYouGet = [
  { icon: '🔍', title: 'Your Hidden Pattern Revealed', description: 'Why you self-sabotage, what your resistance protects, and how to break through' },
  { icon: '👤', title: 'Who You Really Are (Without Masks)', description: 'Your authentic strengths, what makes you unique, and how to use this for success' },
  { icon: '🗓️', title: 'Your 90-Day Action Plan', description: 'Exactly what to do (and especially: what NOT to do) to go from $0 to $10K/month' },
  { icon: '🚀', title: 'Your Personal Success Formula', description: 'How you work best, when you have energy, and how to maintain momentum' },
]
    ...
    <>
      ...
      <section ref={ref} className="py-20 relative">
        <div className="container mx-auto px-4">
          ...
          >
            <p className="text-adhd-yellow font-semibold mb-4">The breakthrough that changes everything</p>
            <h2 className="text-4xl lg:text-5xl font-black mb-4">
              Stop Fighting Your ADHD.<br />
              Use It As Your <span className="gradient-text">Superpower.</span>
            </h2>
            <p className="text-xl text-gray-400">
              In 60 minutes, discover who you really are underneath all the masks -
              and get a personal action plan that fits how your brain works.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className="text-adhd-yellow font-semibold mt-4">{step.duration}</div>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 relative">
        <div className="container mx-auto px-4">
          ...
          >
            This Is What You Get In Your <span className="gradient-text">Personal Transformation Report</span>
          </motion.h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {whatYouGet.map((item, index) => (
              ...
              >
                ...
                <h3 className="text-2xl font-bold mb-4 text-adhd-yellow">{item.title}</h3>
      ...
      <section className="py-20 relative">
        <div className="container mx-auto px-4">
          <motion.h2 
            ...
            className="text-4xl lg:text-5xl font-black text-center mb-16"
          >
            Why This <span className="gradient-text">Actually Works</span> (When Everything Else Fails)
          </motion.h2>
          ...
          <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h3 className="text-2xl font-bold mb-8 text-adhd-red">❌ What You've Tried So Far</h3>
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h3 className="text-2xl font-bold mb-8 text-adhd-green">✅ The ADHD Identity Method™</h3>
              <div className="space-y-4">
                {[
